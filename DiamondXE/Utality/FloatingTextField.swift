...
public class FloatingTextField: UITextField {
    ...
    public var borderWidthF:CGFloat                          = 0.5{
        didSet{
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                ...
                dtLayer.borderWidth         = borderWidthF
                dtLayer.borderColor         = borderColorF.cgColor
            case .sqare:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = borderWidthF
                dtLayer.borderColor         = borderColorF.cgColor
            case .bottom,.left,.right,.top:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = 0.0
                borderLayer.backgroundColor = borderColorF.cgColor
                if dtborderStyle == .bottom {
                    borderLayer.frame = CGRect(x: 0, y: dtLayer.bounds.size.height - borderWidthF, width: dtLayer.bounds.size.width, height: borderWidthF)
                }else if dtborderStyle == .left{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: borderWidthF, height: dtLayer.bounds.size.height)
                }else if dtborderStyle == .right{
                    borderLayer.frame = CGRect(x: dtLayer.bounds.size.width - borderWidth, y: 0, width: borderWidthF, height: dtLayer.bounds.size.height)
                }else{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: dtLayer.bounds.size.width, height: borderWidthF)
                }
    ...
    public var borderColorF:UIColor = UIColor(named: "viewBGClr")!{
        didSet{
            switch dtborderStyle {
    ...
    fileprivate func commonInit() {
        ...
        dtLayer.backgroundColor     = UIColor(named: "viewBGClr")?.cgColor
