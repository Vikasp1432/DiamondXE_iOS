//
//  ReturnOrderCheckoutStruct.swift
//  DiamondXE
//
//  Created by iOS Developer on 07/10/24.
//

import Foundation

struct ReturnOrderCheckoutStruct: Codable {
    var status: Int?
    var msg: String?
    var details: ReturnOrderCheckoutDetails?
}

// MARK: - Details
struct ReturnOrderCheckoutDetails: Codable {
    var orderID: Int?
   ...
   // let courierID, waybill: JSONNull?
    ...
    var returnEligibleDate: String?
    var shippingChargeTax: Int?
    var userDetails: ReturnOrderCheckoutUserDetails?
    var diamonds: [ReturnOrderCheckoutDiamond]?
    var returnOrderSummery: ReturnOrderCheckoutReturnOrderSummery?
    var returnPolicyURL: String?
...
//        case waybill
      ...
      //  case couponValue = "coupon_value"
        ...
        case returnEligibleDate = "return_eligible_date"
        case shippingChargeTax = "shipping_charge_tax"
        case userDetails = "user_details"
        case diamonds
        case returnOrderSummery = "return_order_summery"
        case returnPolicyURL = "return_policy_url"
    }
}

// MARK: - Diamond
struct ReturnOrderCheckoutDiamond: Codable {
...
// MARK: - ReturnOrderSummery
struct ReturnOrderCheckoutReturnOrderSummery: Codable {
    var subTotal, couponDiscount, totalAmount, walletPoints: Int?
    var finalAmount: Int?
...
// MARK: - UserDetails
struct ReturnOrderCheckoutUserDetails: Codable {
    var userRole, userName, userEmail, userMobile: String?
    var billingAddress, shippingAddress, collectFromHub, billingAddressGstNo: String?
    var billingAddressBusinessName, shippingAddressGstNo, shippingAddressBusinessName: String?
    var shippingAddressID,  billingAddressID  : Int?
...
struct ReturnOrderSubmmitedStruct: Codable {
    var status: Int?
    var msg: String?
    enum CodingKeys: String, CodingKey {
        case status
