...
class ItemSummaryDiamondsList: UITableViewCell , ShimmeringViewProtocol{

    static let cellIdentifierItemSummaryDiamondsList = String(describing: ItemSummaryDiamondsList.self)
...
//    func reloadData(){
//        self.tableViewMultiItemContraint.constant = 138 * 2
//        self.tableViewMultiItem.reloadData()
//    }
...
extension ItemSummaryDiamondsList : UITableViewDelegate, UITableViewDataSource {
