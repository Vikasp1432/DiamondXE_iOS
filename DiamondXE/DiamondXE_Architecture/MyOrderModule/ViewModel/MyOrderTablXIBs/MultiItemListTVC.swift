...
class MultiItemListTVC: UITableViewCell, ShimmeringViewProtocol{
    
    static let cellIdentifierMultiItemListTVC = String(describing: MultiItemListTVC.self)
...
extension MultiItemListTVC : UITableViewDelegate, UITableViewDataSource {
