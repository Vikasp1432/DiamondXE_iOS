...
class ReservedListVC: BaseViewController, IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: XLPagerTabStrip.PagerTabStripViewController) -> XLPagerTabStrip.IndicatorInfo {
       // return itemInfo
        return IndicatorInfo(title: "Reserved")
    ...
    private var isLoading = true {
        didSet {
            tableViewReserved.isUserInteractionEnabled = !isLoading
            tableViewReserved.reloadData()
        }
    }
...
extension ReservedListVC : UITableViewDelegate, UITableViewDataSource {
