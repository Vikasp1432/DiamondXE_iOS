...
class ReturnListVC: BaseViewController, IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: XLPagerTabStrip.PagerTabStripViewController) -> XLPagerTabStrip.IndicatorInfo {
       // return itemInfo
        return IndicatorInfo(title: "Return")
    }
    ...
    private var isLoading = true {
        didSet {
            tableViewReturn.isUserInteractionEnabled = !isLoading
            tableViewReturn.reloadData()
        }
    }
