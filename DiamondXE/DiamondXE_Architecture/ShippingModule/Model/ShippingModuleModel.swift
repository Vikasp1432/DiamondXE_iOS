...
//    func getCheckOutDetailsAPISTR(url : String, requestParam: [String:Any], completion: @escaping (CheckOutDataStruct, String?) -> Void) {
//        var resultStruct = CheckOutDataStruct()
//        AlamofireManager().makePostAPIRequestWithQuringSTR(url: url, param: requestParam, completion: { result in
//            switch result {
//            case .success(let data):
//                // Handle the response data
//                do {
